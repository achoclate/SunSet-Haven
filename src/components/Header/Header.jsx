      ...
      <div className="flexCenter innerWidth paddings h-container">
        ...
        >
          <div className="flexCenter h-menu" style={getMenuStyles(menuOpened)}>
            <NavLink to="/properties" style={{ color: 'white' }}>Properties</NavLink>
            <NavLink to="/value"style={{ color: 'white' }}>Value</NavLink>
            <a href="mailto:nyabokeann99@gmail.com"style={{ color: 'white' }}>Contact</a>
